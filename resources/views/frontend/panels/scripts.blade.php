...
<script src="{{ asset('themes/frontend/ads/js/jquery.js') }}"></script>
<script src="{{ asset('themes/frontend/ads/js/plugins.min.js') }}"></script>
<script src="{{ asset('themes/frontend/ads/js/functions.js') }}"></script>
<script src="{{ asset('themes/frontend/ads/js/lazysizes.min.js') }}"></script>
